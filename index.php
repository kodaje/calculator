...
(function($) {
	$.fn.calculateMortgage = function(options) {
		...
		var calculate = function(params) {
			...
			var abc = params.rate; //ncd
			var def= params.balance; //market value
		...
		<div class="container">
			<div class="breadcrumb-info text-center">
				<div class="page-title">
					<h1>Car <br> <font color='red'>Insurance Calculator</font></h1>
				</div>		
				...
				<div class="col-sm-9">
					<div class="short-info code-edit-small">
						<div class="section">
							...
							<span class="tr-title">Estimate Insurance NCD</span>
							<div class="row">
								<div class="col-sm-3">
									<label>Market Price</label>
								</div>
								<div class="col-xs-2">
									<input name="balance" id="balance" type="text" value ="65" class="form-control"/>
 								</div>
							</div><!-- /.row -->
								...
								<div class="col-sm-9">
									...
									<div class="row">
										<div class="col-sm-6">
											...
											<option value ="25">First Year-25%</option>
											<option value ="30">Second Year-30%</option>
											<option value ="38.33">Third Year-38.33%</option>
											<option value ="45">Fourth Year-45%</option>
											<option value ="55">Fifth Year-55%</option>
											</select>
										</div>
									</div>									
								</div>
...
<p align="right" class="ncdstyle">NCD Payment is: <span id="ncd"></span></p>
<p align="right" class="ncdstyle">SST tax is: <span id="sst"></span></p>
<p align="right" class="ncdstyle"><strong>Your Total Payment is: <span id="total"></span></strong></p>
